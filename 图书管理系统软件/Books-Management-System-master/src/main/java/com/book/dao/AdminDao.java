...
public class AdminDao {
    ...
    private static final String MATCH_ADMIN_SQL="SELECT COUNT(*) FROM admin where Admin_id = ? and Admin_password = ? ";
    private static final String RE_PASSWORD_SQL="UPDATE admin set Admin_password = ? where admin_id = ? ";
    private static final String GET_PASSWD_SQL="SELECT Admin_password from admin where admin_id = ?";
