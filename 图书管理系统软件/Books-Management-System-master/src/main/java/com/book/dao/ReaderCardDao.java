...
public class ReaderCardDao {
    ...
    private final static String ADD_READERCARD_SQL="INSERT INTO reader_card (reader_id,name,passwd,card_state) values ( ? , ? , ?, ?)";
    ...
    public int addReaderCard(ReaderInfo readerInfo){
        ...
        return jdbcTemplate.update(ADD_READERCARD_SQL,new Object[]{readerId,name,111111,1});
    }
