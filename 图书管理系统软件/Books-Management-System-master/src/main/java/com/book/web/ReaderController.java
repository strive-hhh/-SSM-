...
public class ReaderController {
    ...
    public String readerInfoEditDo(HttpServletRequest request,String name,int level,String sex,String birth,String address,String telcode,RedirectAttributes redirectAttributes){
    ...
    public String readerInfoAddDo(int readerId,String name,int level,String sex,String birth,String address,String telcode,RedirectAttributes redirectAttributes){
        SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
        Date nbirth=new Date();
        try{
            java.util.Date date=sdf.parse(birth);
...
//读者功能--读者信息修改
    ...
    public ModelAndView queryDo(HttpServletRequest request,String searchWord){
        boolean exist=readerInfoService.matchReader(searchWord);
        if (exist){
            ArrayList<ReaderInfo> readers = readerInfoService.queryBook(searchWord);
            ModelAndView modelAndView = new ModelAndView("admin_readers");
            modelAndView.addObject("readers",readers);
            return modelAndView;
        }
