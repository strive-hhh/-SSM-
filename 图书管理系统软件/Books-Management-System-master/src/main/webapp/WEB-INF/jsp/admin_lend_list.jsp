                ...
                <tr>
                    ...
                    <td>
                        <c:if test="${alog.backshouldDate<alog.backDate}">
                            <font color="#ff6347">
                                <c:out value="${alog.readerId}"></c:out>
                            </font>
                        </c:if>
                        <c:if test="${alog.backshouldDate>=alog.backDate}">
                            <c:out value="${alog.readerId}"></c:out>
                    ...
                    <td><a href="deleteLendlist.html?sernum=<c:out value="${alog.sernum}"></c:out>"><button type="button" class="btn btn-danger btn-xs">删除</button></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
