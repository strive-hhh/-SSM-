...
<div style="padding: 70px 550px 10px">
    <form   method="post" action="queryreader.html" class="form-inline"  id="searchform">
        <div class="input-group">
            <input type="text" placeholder="输入读者名或学号" class="form-control" id="search" name="searchWord" class="form-control">
...
<div class="panel panel-default" style="position:relative;top: 15px;width: 90%;margin-left: 5%">
        ...
        <table class="table table-hover" >
            ...
            <c:forEach items="${readers}" var="reader">
                <tr>
                    ...
                    <c:if test="${reader.level==1}">
                        <td>本科生</td>
                    </c:if>
                    <c:if test="${reader.level==2}">
                        <td>研究生</td>
                    </c:if>
                    <c:if test="${reader.level==3}">
                        <td>教职工</td>
                    </c:if>
